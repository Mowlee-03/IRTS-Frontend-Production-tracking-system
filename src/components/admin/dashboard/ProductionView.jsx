...
const ProductionView = () => {
  ...
  return (
        <div className="bg-white h-full rounded-xl shadow-bg-shadow-2 px-4 pt-4">
          <p className=" flex items-center font-medium">Production Overview</p>
          <div className="flex  gap-2 h-[15%]">
            <div className="bg-blue-100 rounded-lg px-2 pt-1 flex-1">
              <div className="text-sm text-blue-800">Awaiting Production</div>
              <div className="text-lg font-bold text-blue-600">{productionData.awaiting}</div>
            </div>
            <div className="bg-green-100 rounded-lg  px-2 pt-1 flex-1">
              <div className="text-sm text-green-800">In progress</div>
              <div className="text-xl font-bold text-green-600">{productionData.inProgress}</div>
            </div>
            <div className="bg-yellow-100 rounded-lg  px-2 pt-1 flex-1">
              <div className="text-sm text-yellow-800">Completed production</div>
              <div className="text-xl font-bold text-yellow-600">{productionData.completed}</div>
            </div>
          </div>
          ...
          <div className="h-[60%]">
            ...
            sx={{
              ...
              // height={180}
              margin={{ top: 0, bottom: 10, left: 0, right: 30 }}
              slotProps={{
                legend: {
                  hidden: true,
                },
